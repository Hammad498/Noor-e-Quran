...
class SurahDetailModel {
  ...
  SurahDetailModel({required this.detail, required this.verses});
  ...
  factory SurahDetailModel.fromJson(Map<String, dynamic> json) {
    return SurahDetailModel(
      detail: SurahModel(
        ...
        meaning: json['arti'],
        // Some sources use 'deskripsi', keep backward compatibility
        description: json['deskripsi'] ?? json['deksripsi'] ?? '',
      ),
