...
class _SearchBoxState extends ConsumerState<SearchBox> {
  ...
  Widget build(BuildContext context) {
    return SearchAnchor(
      ...
      headerTextStyle: FontStyles.regular.copyWith(fontSize: 14),
      viewElevation: 0,
      viewTrailing: [
        IconButton(
      ...
      builder: (context, controller) {
        return TextField(
          ...
          style: FontStyles.regular.copyWith(fontSize: 12, height: 1.5),
        );
      },
          ...
          builder: (context, ref, child) {
            ...
            return results.when(
              data: (data) {
                ...
                return ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return InkWell(
                      overlayColor: WidgetStateProperty.all(ThemeColor.surface),
              ...
              error: (error, stackTrace) {
                return Center(child: Text('Error', style: FontStyles.regular));
              },
              loading: () {
                return ListView(
                  children: const [
